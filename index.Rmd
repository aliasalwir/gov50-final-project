...
data_plot <- da35040.0001 |> 
  mutate(
    Q102A = case_when(Q102 == "(5) 5. much worse" ~ 5,
    ...
    group_by(Countries)|>
    summarize(mean_Q102=mean(Q102A,na.rm = T))
...
data_plot |>  
  ...
  labs(x = "Country", 
       ...
       subtitle = "Source: Arab Barometer: Public Opinion Survey 20010-2011")+
