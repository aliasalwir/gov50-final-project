...
data_2010_2011 <- da35040.0001 |> 
  mutate(
    ...
    Countries = case_when(
      ...
      COUNTRY == "(21) 21. Tunisia" ~ "Tunisia", 
      COUNTRY == "(22) 22. Yemen" ~ "Yemen"),
    Q2011B = case_when(Q2011 == "(1) a great deal of trust" ~ 1,
                       ...
                       TRUE ~ NA_real_),
    Q2012B = case_when(Q2012 == "(1) a great deal of trust" ~ 1,
                       ...
                       TRUE ~ NA_real_),
    Q2013B = case_when(Q2013 == "(1) a great deal of trust" ~ 1,
                       ...
                       TRUE ~ NA_real_),
    Q2014B = case_when(Q2014 == "(1) a great deal of trust" ~ 1,
                       ...
                       TRUE ~ NA_real_),
    Q2015B = case_when(Q2015 == "(1) a great deal of trust" ~ 1,
                       ...
                       TRUE ~ NA_real_),
    Q2016B = case_when(Q2016 == "(1) a great deal of trust" ~ 1,
                       ...
                       TRUE ~ NA_real_),
    Q2017B = case_when(Q2017 == "(1) a great deal of trust" ~ 1,
  ...
  rename(economic_opporunity_2011 =  Q102,
         ...
         Employment = Q1004,
         Religion = Q1012)|>
  summarize(mean_trust_2011 = (mean(Q2011B) + mean(Q2012B) + mean(Q2013B) + mean(Q2014B) + mean(Q2015B) 
                               + mean(Q2016B) + mean(Q2017B)  / 7))


data_2010_2011$mean_trust_2011 <- rowMeans(first.regression[,c('Q2011B','Q2012B','Q2013B','Q2014B','Q2015B', 'Q2016B', 'Q2017B')],na.rm = T)

    
data_2010_2011|>
  ggplot(aes(y = mean_trust_2011, x = economic_opporunity_2011))+
  geom_point()+
  geom_smooth(method = "lm")+
  labs(x = "Mean of Economic Optimism 
       (1 being the most optimistic and 5 being the least optimistic)", 
...
fit1_2011 <- lm(mean_trust_2011 ~ economic_opporunity_2011 + Age + Sex + Education + Religion + Employment, data = data_2010_2011)
summary(fit1)

fit2 <- lm(mean_trust ~ economic_opporunity + Age + Sex +Education+factor(Countries), data = data_2010_2011)
summary(fit2)
