...
spread_trust_2006 <- first.regression|>
  ...
  labs(x = "Trust In Government Institutions  
       (1 being the most trust and 4 being the least trust)", 
       y = "Count",
       title = "Spread of Trust in Government Institutions",
       subtitle = "Source: Arab Barometer: Public Opinion Survey 2006-2009")
spread_trust_2006
```
...
fit1_2011 <- lm(mean_trust ~ economic_opporunity_2011 + Age + Sex + Education + Religion + Employment, data = data_2010_2011)
summary(fit1)

fit2_2011 <- lm(mean_trust ~ economic_opporunity_2011 + Age + Sex +Education+Religion+Employment+factor(Countries), data = data_2010_2011)
summary(fit2_2011)
